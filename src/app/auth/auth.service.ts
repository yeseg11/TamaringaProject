...
export class AuthService {
  ...
  createUser(fullName: string, id: number, age: number, password: string, country: string) {
    const authData: AuthData = {fullName: fullName, id: id, age: age, password: password, country: country};
  ...
  login(id: number, password: string) {
    const authDataLogin: AuthDataLogin = {id: id, password: password};
